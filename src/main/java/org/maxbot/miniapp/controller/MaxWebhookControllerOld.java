...
@RestController
public class MaxWebhookControllerOld {

    private final Map<Integer, String> userState = new ConcurrentHashMap<>();
    private final PatentSearchService patentSearchService;
    private static final Logger log = LoggerFactory.getLogger(MaxWebhookControllerOld.class);
    private final MaxApiClient maxApiClient;

    public MaxWebhookControllerOld(@Value("${max.token}") String token,
